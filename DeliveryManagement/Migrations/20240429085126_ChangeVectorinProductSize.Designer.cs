...
namespace DeliveryManagement.Migrations
{
    ...
    [Migration("20240429085126_ChangeVectorinProductSize")]
    partial class ChangeVectorinProductSize
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DeliveryManagement.Models.Product", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Size", "DeliveryManagement.Models.Product.Size#Vector", b1 =>
                        {
                            b1.IsRequired();
