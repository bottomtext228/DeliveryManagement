    ...
    return <>
        <div className="">
            <div className="bg-linear-to-b from-white to-neutral-300">
                <div className="max-w-[1440px] w-[90%] h-fit h-screen mx-auto md:flex">

                    <ScrollAppear duration={1000} visibleClasses={'opacity-100 translate-x-0'} hiddenClasses={'opacity-0 -translate-x-50'}>
                    ...
                    <ScrollAppear duration={1000} delay={500} visibleClasses="opacity-100 translate-x-0" hiddenClasses="opacity-0 translate-x-50">
                ...
                <ScrollAppear duration={1000} visibleClasses="opacity-100 translate-y-0" hiddenClasses="opacity-0 translate-y-5">
            ...
            <div className="max-w-[1440px] w-[90%] mx-auto">
                <div className="md:flex">
                    <ScrollAppear duration={1000} delay={250} visibleClasses="opacity-100 translate-x-0" hiddenClasses="opacity-0 -translate-x-50">
                    ...
                    <div className="flex-4/6 md:flex md:rounded-full md:bg-orange-50">
                        ...
                        <ScrollAppear duration={1000} delay={400} visibleClasses="opacity-100 translate-y-0" hiddenClasses="opacity-0 translate-y-50">
            ...
            <div className="bg-orange-100 ">
                ...
                <div className="max-w-[1440px] w-[90%] mx-auto h-96 md:my-64 my-24 flex md:flex-row flex-col gap-2 justify-around items-center">
                    ...
                    <ScrollAppear duration={1000} delay={500} visibleClasses="opacity-100 translate-y-0" hiddenClasses="opacity-0 translate-y-100" >
